<template>
  <div class="footer-wrapper">
    <span>
      ...
      <a target="blank" href="https://luckykeeper.site">{{`Based on vuepress-theme-reco@${version} modified By Luckykeeper`}}</a>
    </span>
    <span>
      <reco-icon icon="reco-api" />
      <a target="blank" href="https://github.com/LOVE69-Renpy-Remaster-Project/Doc">{{`文档站GitHub源码`}}</a>
    </span>
